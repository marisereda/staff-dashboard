...
INSERT INTO "new_Employee" ("code1C", "createdAt", "employerId", "id", "inn", "isFop", "markDelete", "name", "newPosition", "newStoreId", "phone", "position", "positionBuh", "storeAddressBuh", "storeId", "updatedAt") SELECT "code1C", "createdAt", "employerId", "id", "inn", "isFop", "markDelete", "name", "newPosition", "newStoreId", "phone", "position", "positionBuh", "storeAddressBuh", "storeId", "updatedAt" FROM "Employee";
DROP TABLE "Employee";
